...
public class CreateEntityResponse {
  ...
  **/
  ...
  public CreateEntityResponse addAggregatorsItem(Aggregator aggregatorsItem) {
  ...
  **/
  ...
  public CreateEntityResponse addInstitutionIdsItem(String institutionIdsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, createEntityResponse.id) &&
        Objects.equals(this.email, createEntityResponse.email) &&
        Objects.equals(this.aggregators, createEntityResponse.aggregators) &&
        Objects.equals(this.institutionIds, createEntityResponse.institutionIds) &&
        Objects.equals(this.requestId, createEntityResponse.requestId);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateEntityResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateEntityResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateEntityResponse is not found in the empty JSON string", CreateEntityResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateEntityResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateEntityResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateEntityResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateEntityResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateEntityResponse>() {
           @Override
           public void write(JsonWriter out, CreateEntityResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateEntityResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CreateEntityResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateEntityResponse
  * @throws IOException if the JSON string is invalid with respect to CreateEntityResponse
  */
  public static CreateEntityResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateEntityResponse.class);
  }

 /**
  * Convert an instance of CreateEntityResponse to an JSON string
  *
  * @return JSON string
  */
